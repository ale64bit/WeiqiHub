...
class Settings {
  ...
  bool get deleteCorrectlySolvedMistakes =>
      prefs.getBool('$_behaviourKeyPrefix.delete_correctly_solved_istakes') ??
      false;

  set deleteCorrectlySolvedMistakes(bool val) => prefs.setBool(
      '$_behaviourKeyPrefix.delete_correctly_solved_istakes', val);
